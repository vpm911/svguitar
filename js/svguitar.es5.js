...
var SVGuitarChord = /** @class */ (function () {
    ...
    SVGuitarChord.prototype.drawTunings = function (y) {
        ...
        tuning.map(function (tuning, i) {
            if (i < strings) {
                var tuningText = _this.renderer.text(tuning, stringXPositions[i], y + padding, tuningsFontSize, color, fontFamily, Alignment.MIDDLE);
                if (tuning) {
                    text = tuningText;
                }
            }
    ...
    SVGuitarChord.prototype.drawGrid = function (y) {
        ...
        this._chord.fingers
            ...
            if (text) {
                _this.renderer.text(text, nutCenterX, nutCenterY, nutTextSize, nutTextColor, fontFamily, Alignment.MIDDLE, true);
            }
        });
        // draw barre chords
        this._chord.barres.forEach(function (_a) {
            ...
            if (text) {
                _this.renderer.text(text, fromStringX + distance / 2, barreCenterY, nutTextSize, nutTextColor, fontFamily, Alignment.MIDDLE, true);
            }
        });
        return y + height;
    };
    SVGuitarChord.prototype.drawTitle = function (size) {
        ...
        // draw the title
        var _a = this.renderer.text(title, constants.width / 2, 5, size, color, fontFamily, Alignment.MIDDLE), x = _a.x, y = _a.y, width = _a.width, height = _a.height, remove = _a.remove;
...
export { ChordStyle, FretLabelPosition, OPEN, SILENT, SVGuitarChord };
